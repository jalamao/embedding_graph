...
def generate_deep_embedding(X, target=None,
    ...
    print("finished deep model compilation, training..")
...
def hinmine_embedding_pr(network,targets, parallel=True,verbose=False,community_information=True,deep_embedding=False):
...
if __name__ == "__main__":
    ...
    embeddings = hinmine_embedding_pr(core_network,labels, parallel=True,verbose=True,community_information=True,deep_embedding=True)
