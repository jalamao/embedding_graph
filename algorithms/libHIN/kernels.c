 ...
 * 
 */
  __pyx_tuple__10 = PyTuple_Pack(6, __pyx_n_s_A, __pyx_n_s_n, __pyx_n_s_x, __pyx_n_s_i, __pyx_n_s_j, __pyx_n_s_Sp); if (unlikely(!__pyx_tuple__10)) __PYX_ERR(0, 6, __pyx_L1_error)
